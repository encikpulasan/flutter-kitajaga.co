...
class _$AuthTearOff {
  ...
  _Auth call(
      {String? accessToken, int? expiresIn, String? tokenType, String? scope}) {
    return _Auth(
...
class _$_Auth implements _Auth {
  const _$_Auth({this.accessToken, this.expiresIn, this.tokenType, this.scope});
  ...
  @override
  String toString() {
    return 'Auth(accessToken: $accessToken, expiresIn: $expiresIn, tokenType: $tokenType, scope: $scope)';
  }
