...
_$_HelperDetails _$_$_HelperDetailsFromJson(Map<String, dynamic> json) {
  return _$_HelperDetails(
    ...
    doneHelping: json['done_helping'] as bool?,
    position: json['position'] == null ? null : Position.fromJson(json['position'] as Map<String, dynamic>),
  );
}

Map<String, dynamic> _$_$_HelperDetailsToJson(_$_HelperDetails instance) => <String, dynamic>{
      'id': instance.id,
      ...
      'done_helping': instance.doneHelping,
